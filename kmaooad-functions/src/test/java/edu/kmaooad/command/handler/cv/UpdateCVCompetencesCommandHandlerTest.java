...
public class UpdateCVCompetencesCommandHandlerTest {
    ...
    public void shouldUpdateCVCompetences(){
        Long chatId = 1L;
        UserRequest userRequest = UserRequest.builder().chatId(chatId).text("/updateCVCompetences").isCommand(true).build();
        ...
        updateCVCompetencesCommandHandler = new UpdateCVCompetencesCommandHandler(telegramService, userStateService, cvService);
        Assertions.assertTrue(updateCVCompetencesCommandHandler.canHandle(Command.UPDATE_CV_COMPETENCES));
