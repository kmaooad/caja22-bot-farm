...
public class UpdateCVCommandHandler implements CommandHandler  {
    ...
    private enum UpdateCVState implements CommandState {
        ...
        WAITING_FOR_UPDATE_NAME("ADD_CV_WAITING_FOR_NAME", "Please, enter you full name (must not be empty) or 'skip' to skip this field"),
        WAITING_FOR_UPDATE_DESCRIPTION(
                "ADD_CV_WAITING_FOR_DESCRIPTION", "Please, enter short summary (can be empty) or 'skip' to skip this field"),
        WAITING_FOR_UPDATE_ACTIVITIES(
                "ADD_CV_WAITING_FOR_ACTIVITIES",
                "Please, enter a list of job activities (as comma-separated list) or 'skip' to skip this field"),
        ...
        WAITING_FOR_UPDATE_COMPETENCES(
                ...
                "Please, enter a list of you job competences (as comma-separated list) or 'skip' to skip this field"),
        WAITING_FOR_UPDATE_PREFERENCES(
                "ADD_CV_WAITING_FOR_PREFERENCES",
                "Please, enter a list of you job preferences (as comma-separated list) or 'skip' to skip this field"),
    ...
    private void performStateAction(UserRequest userRequest, UserState userState) {
        final UpdateCVCommandHandler.UpdateCVState currentState = (UpdateCVCommandHandler.UpdateCVState) userState.getCommandState();
        ...
        switch (currentState) {
            case WAITING_FOR_UPDATE_CV_DECISION:
                ...
                UpdateCVCommandHandler.UpdateCVState nextState = Objects.equals(userInput, "Y") ? UpdateCVState.WAITING_FOR_UPDATE_CV_ID_NAME : UpdateCVState.WAITING_FOR_UPDATE_CV_ID;
            ...
            case WAITING_FOR_UPDATE_CV_ID:
                ...
                telegramService.sendMessage(chatId, UpdateCVCommandHandler.UpdateCVState.WAITING_FOR_UPDATE_NAME.getMessage());
                userStateService.setStateForUser(chatId, userState);
                break;
            ...
            case WAITING_FOR_UPDATE_NAME:
                ...
                userState.setCommandState(UpdateCVCommandHandler.UpdateCVState.WAITING_FOR_UPDATE_DESCRIPTION);
                telegramService.sendMessage(chatId, UpdateCVCommandHandler.UpdateCVState.WAITING_FOR_UPDATE_DESCRIPTION.getMessage());
                userStateService.setStateForUser(chatId, userState);
                break;

            case WAITING_FOR_UPDATE_DESCRIPTION:
                userState.addInput("description", userInput);
                userState.setCommandState(UpdateCVCommandHandler.UpdateCVState.WAITING_FOR_UPDATE_ACTIVITIES);
                telegramService.sendMessage(chatId, UpdateCVCommandHandler.UpdateCVState.WAITING_FOR_UPDATE_ACTIVITIES.getMessage());
                userStateService.setStateForUser(chatId, userState);
                break;

            case WAITING_FOR_UPDATE_ACTIVITIES:
                userState.addInput("activities", userInput);
                userState.setCommandState(UpdateCVCommandHandler.UpdateCVState.WAITING_FOR_UPDATE_MANAGE_COMPETENCIES);
                telegramService.sendMessage(chatId, UpdateCVCommandHandler.UpdateCVState.WAITING_FOR_UPDATE_MANAGE_COMPETENCIES.getMessage());
                userStateService.setStateForUser(chatId, userState);
                break;

            case WAITING_FOR_UPDATE_MANAGE_COMPETENCIES:
                userState.addInput("manageCompetencies", userInput);
                UpdateCVState nextState1 = Objects.equals(userInput, "Y") ? UpdateCVCommandHandler.UpdateCVState.WAITING_FOR_UPDATE_PREFERENCES : UpdateCVCommandHandler.UpdateCVState.WAITING_FOR_UPDATE_COMPETENCES;
            ...
            case WAITING_FOR_UPDATE_COMPETENCES:
                ...
                userState.setCommandState(UpdateCVCommandHandler.UpdateCVState.WAITING_FOR_UPDATE_PREFERENCES);
                telegramService.sendMessage(chatId, UpdateCVCommandHandler.UpdateCVState.WAITING_FOR_UPDATE_PREFERENCES.getMessage());
                userStateService.setStateForUser(chatId, userState);
                break;

            case WAITING_FOR_UPDATE_PREFERENCES:
                userState.addInput("preferences", userInput);
                userState.setCommandState(UpdateCVCommandHandler.UpdateCVState.WAITING_FOR_UPDATE_IS_ACTIVE);
                telegramService.sendMessage(chatId, UpdateCVCommandHandler.UpdateCVState.WAITING_FOR_UPDATE_IS_ACTIVE.getMessage());
                userStateService.setStateForUser(chatId, userState);
                break;
            ...
            case WAITING_FOR_UPDATE_IS_ACTIVE:
                ...
                if (Objects.equals(inputs.get("decision"), "Y")) {
                    if (cvService.getCVByName(inputs.get("idname")).isPresent()) {
                        final CV cv = cvService.getCVByName(inputs.get("idname")).get();
                    ...
                    if (cvService.getCVById(inputs.get("id")).isPresent()) {
                        final CV cv = cvService.getCVById(inputs.get("id")).get();
                        final UpdateCVDTO updateCVDTO =
                                UpdateCVDTO.builder()
                                        .id(cv.getId())
                                        .name(Objects.equals(inputs.get("name"), "skip") ? cv.getName(): inputs.get("name"))
    ...
    private void initializeUserState(UserRequest userRequest, UserState userState) {
        ...
        userStateService.setStateForUser(chatId, userState);
        telegramService.sendMessage(chatId, UpdateCVCommandHandler.UpdateCVState.WAITING_FOR_UPDATE_CV_DECISION.getMessage());
    }
