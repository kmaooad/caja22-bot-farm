...
public class AddCVCommandHandler implements CommandHandler  {
    ...
    private enum AddCVState implements CommandState {
        ...
        WAITING_FOR_IS_ACTIVE(
                "ADD_CV_WAITING_FOR_IS_ACTIVE",
                        "Are you open to new opportunities? (Y or N)");
    ...
    private void performStateAction(UserRequest userRequest, UserState userState) {
        final AddCVCommandHandler.AddCVState currentState = (AddCVCommandHandler.AddCVState) userState.getCommandState();
        ...
        switch (currentState) {
            case WAITING_FOR_NAME:
                ...
                telegramService.sendMessage(chatId, AddCVCommandHandler.AddCVState.WAITING_FOR_DESCRIPTION.getMessage());
            ...
            case WAITING_FOR_DESCRIPTION:
                ...
                telegramService.sendMessage(chatId, AddCVCommandHandler.AddCVState.WAITING_FOR_ACTIVITIES.getMessage());
                userStateService.setStateForUser(chatId, userState);
                break;
            ...
            case WAITING_FOR_ACTIVITIES:
                ...
                telegramService.sendMessage(chatId, AddCVCommandHandler.AddCVState.WAITING_FOR_MANAGE_COMPETENCIES.getMessage());
                userStateService.setStateForUser(chatId, userState);
                break;

            case WAITING_FOR_MANAGE_COMPETENCIES:
                userState.addInput("manageCompetencies", userInput);
                AddCVState nextState = Objects.equals(userInput, "Y") ? AddCVCommandHandler.AddCVState.WAITING_FOR_PREFERENCES : AddCVCommandHandler.AddCVState.WAITING_FOR_COMPETENCES;
