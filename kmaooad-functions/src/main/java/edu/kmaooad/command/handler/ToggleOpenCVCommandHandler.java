...
public class ToggleOpenCVCommandHandler implements CommandHandler {
    ...
    private enum ToggleHireCVState implements CommandState {
        ...
        WAITING_FOR_TOGGLE_CV_ID(
                "TOGGLE_CV_WAITING_FOR_ID", "Please, enter an id of the cv which you want to toggle hire status"),
        WAITING_FOR_TOGGLE_CV_NAME(
                "TOGGLE_CV_WAITING_FOR_NAME", "Please, enter your full name");
    ...
    private void performStateAction(UserRequest userRequest, UserState userState) {
        ...
        switch (currentState) {
            case WAITING_FOR_TOGGLE_CV_DECISION:
                ...
                ToggleOpenCVCommandHandler.ToggleHireCVState nextState = Objects.equals(userInput, "Y") ? ToggleHireCVState.WAITING_FOR_TOGGLE_CV_NAME : ToggleHireCVState.WAITING_FOR_TOGGLE_CV_ID;
